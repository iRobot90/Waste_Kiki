...
export default function CitizenHome() {
  ...
  // const [signed, setSigned] = useState(false); // Removed the signed variable
  // console.log(signed);
  return (
    <div>
      <div className="sm:flex h-fit">
        <div className="bg-teal-900 sm:w-1/2 text-center sm:text-justify p-10">
          {user ? <CitizenLanding /> : <SignUp />} {/* Removed the signed prop */}
        </div>
      ...
      <div className=" sm:flex h-fit">
        ...
        <div className="bg-teal-900 sm:w-1/2 grid justify-items-center sm:justify-items-end ... ">
          <video
            ...
            loop
            muted
            className="mt-12 sm:mt-20 h-4/6 rounded-xl sm:rounded-l-full ..."
          >

...
export default function PickUp() {
  ...
  const [imgUrl, setImgUrl] = React.useState(
    "https://www.rd.com/wp-content/uploads/2018/05/garbage-finds-ft.jpg?resize=700,467"
  );
  ...
  return (
    <div>
      {message ? (
        <h3 className="bg-green-500 text-white p-4 rounded-xl text-center">
          {message}
        </h3>
      ) : (
        <form
          onSubmit={handleSubmit}
          className="max-w-[400px] w-full mt-20 mx-auto rounded-xl bg-teal-900 text-white p-4"
        >
          ...
          <div className="flex flex-col py-2">
            ...
            >
              ...
              <option value="Blue">
                Blue( plastic wrappers and non-bioderadable wastes)
              </option>
          ...
          <div className="flex flex-col py-2">
            ...
            <img
              src={imgUrl}
              className="profile-pic border p-2"
              alt="profile pic"
            />
            <input
              type="file"
          ...
          <button className="border w-full my-5 py-2 bg-white text-teal-900">
            Schedule
          </button>
        </form>
      )}

        ...
        <form onSubmit={handleSubmit} className="max-w-[400px] w-full mx-auto rounded-xl bg-white p-4">
            ...
            <div className="flex flex-col py-2">
                ...
                <select id="truckColour" onChange={(e) => setTruckColour(e.target.value)} required >
                    ...
                    <option value="Green">Green(Wet and Biodegradable wastes)</option>
                    <option value="Blue">Blue(Plastic wrappers and Non-biodegradable wastes)</option>
                </select>
            </div>
            <button className="border w-full my-5 py-2 bg-teal-900 hover:bg-teal-800 text-white" type="submit">Sign Up</button>
        </form>
    );
}
